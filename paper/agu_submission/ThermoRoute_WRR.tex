...
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/fig01\_preopening\_concept.pdf\}
\textbackslash caption\{Figure 1. The cohort, and what its geometry can carry.\}
\textbackslash label\{fig:F1\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{../si/figures/figS1\_cohort\_registry.pdf\}
\textbackslash caption\{Figure S1. Cohort selection and registry geometry.\}
\textbackslash label\{fig:S1\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{../si/figures/figS2\_information\_boundary.pdf\}
\textbackslash caption\{Figure S2. Temporal chronology and information/product boundary.\}
\textbackslash label\{fig:S2\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{../si/figures/figS3\_model\_architecture.pdf\}
\textbackslash caption\{Figure S3. Full model, bound, and calibration dataflow.\}
\textbackslash label\{fig:S3\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/fig02\_point\_performance.pdf\}
\textbackslash caption\{Figure 2. Baseline choice, not architecture, sets the reported gain.\}
\textbackslash label\{fig:F2\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS4\_point\_heterogeneity.pdf\}
\textbackslash caption\{Figure S4. Point-performance heterogeneity.\}
\textbackslash label\{fig:S4\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/fig03\_spatial\_partition\_transfer.pdf\}
\textbackslash caption\{Figure 3. The spatial partition changes the transfer conclusion.\}
\textbackslash label\{fig:F3\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/fig04\_heterogeneity\_and\_interval\_cost.pdf\}
\textbackslash caption\{Figure 4. Regional and seasonal heterogeneity, and what coverage costs.\}
\textbackslash label\{fig:F4\}
\textbackslash end\{figure\}
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS7\_spatial\_leave\_huc2.pdf\}
\textbackslash caption\{Figure S7. Spatial and leave-HUC2 influence.\}
\textbackslash label\{fig:S7\}
\textbackslash end\{figure\}
...
\textbf{Table 4.7a. Accuracy (RMSE, MAE, bias) --- primary models.} \emph{n} = 118,275 (h = 1 d), 117,476 (h = 3 d), 116,524 (h = 7 d) forecast keys.

{\small
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.12}
\noindent
\begin{tabularx}{\dimexpr\linewidth-24pt\relax}{@{}lrll>{\raggedright\arraybackslash}X@{}}
\toprule\noalign{}
Model & h (d) & RMSE (°C) & MAE (°C) & bias (°C) \\
\midrule\noalign{}
Persistence & 1 & \texttt{0.829} & \texttt{0.574} & \texttt{-0.001} \\
Persistence & 3 & \texttt{1.645} & \texttt{1.168} & \texttt{-0.004} \\
Persistence & 7 & \texttt{2.237} & \texttt{1.607} & \texttt{-0.012} \\
DampedPersistence & 1 & \texttt{0.799} & \texttt{0.561} & \texttt{-0.034} \\
DampedPersistence & 3 & \texttt{1.457} & \texttt{1.050} & \texttt{-0.091} \\
DampedPersistence & 7 & \texttt{1.759} & \texttt{1.288} & \texttt{-0.173} \\
Climatology & 1 & \texttt{1.948} & \texttt{1.454} & \texttt{-0.382} \\
Climatology & 3 & \texttt{1.948} & \texttt{1.454} & \texttt{-0.380} \\
Climatology & 7 & \texttt{1.950} & \texttt{1.456} & \texttt{-0.378} \\
LightGBM & 1 & \texttt{0.605} & \texttt{0.422} & \texttt{-0.027} \\
LightGBM & 3 & \texttt{1.334} & \texttt{0.962} & \texttt{-0.109} \\
LightGBM & 7 & \texttt{1.708} & \texttt{1.256} & \texttt{-0.200} \\
LSTM & 1 & \texttt{0.688} & \texttt{0.493} & \texttt{-0.006} \\
LSTM & 3 & \texttt{1.369} & \texttt{1.003} & \texttt{-0.062} \\
LSTM & 7 & \texttt{1.708} & \texttt{1.257} & \texttt{-0.163} \\
ThermoRoute & 1 & \texttt{0.658} & \texttt{0.462} & \texttt{+0.014} \\
ThermoRoute & 3 & \texttt{1.342} & \texttt{0.971} & \texttt{-0.033} \\
ThermoRoute & 7 & \texttt{1.686} & \texttt{1.235} & \texttt{-0.129} \\
\bottomrule\noalign{}
\end{tabularx}
}

\textbf{Table 4.7b. Skill vs persistence and climatology --- primary models.}

{\small
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.12}
\noindent
\begin{tabularx}{\dimexpr\linewidth-24pt\relax}{@{}lrl>{\raggedright\arraybackslash}X@{}}
\toprule\noalign{}
Model & h (d) & skill vs. persist & skill vs. clim \\
\midrule\noalign{}
Persistence & 1 & \texttt{0.000} & \texttt{0.574} \\
Persistence & 3 & \texttt{0.000} & \texttt{0.156} \\
Persistence & 7 & \texttt{0.000} & \texttt{-0.147} \\
DampedPersistence & 1 & \texttt{0.036} & \texttt{0.590} \\
DampedPersistence & 3 & \texttt{0.114} & \texttt{0.252} \\
DampedPersistence & 7 & \texttt{0.213} & \texttt{0.098} \\
Climatology & 1 & \texttt{-1.349} & \texttt{0.000} \\
Climatology & 3 & \texttt{-0.184} & \texttt{0.000} \\
Climatology & 7 & \texttt{0.128} & \texttt{0.000} \\
LightGBM & 1 & \texttt{0.270} & \texttt{0.689} \\
LightGBM & 3 & \texttt{0.189} & \texttt{0.315} \\
LightGBM & 7 & \texttt{0.236} & \texttt{0.124} \\
LSTM & 1 & \texttt{0.171} & \texttt{0.647} \\
LSTM & 3 & \texttt{0.167} & \texttt{0.297} \\
LSTM & 7 & \texttt{0.236} & \texttt{0.124} \\
ThermoRoute & 1 & \texttt{0.207} & \texttt{0.662} \\
ThermoRoute & 3 & \texttt{0.184} & \texttt{0.311} \\
ThermoRoute & 7 & \texttt{0.246} & \texttt{0.135} \\
\bottomrule\noalign{}
\end{tabularx}
}

\textbf{Table 4.8a. Accuracy (RMSE, MAE, bias) --- one-factor ablations.} \emph{n} = 118,275 (h = 1 d), 117,476 (h = 3 d), 116,524 (h = 7 d) forecast keys.
...
Model & h (d) & RMSE (°C) & MAE (°C) & bias (°C) \\
\midrule\noalign{}
tr-fixedkappa & 1 & \texttt{0.654} & \texttt{0.458} & \texttt{+0.015} \\
tr-fixedkappa & 3 & \texttt{1.341} & \texttt{0.970} & \texttt{-0.043} \\
tr-fixedkappa & 7 & \texttt{1.684} & \texttt{1.233} & \texttt{-0.127} \\
tr-nodynamicprior & 1 & \texttt{0.654} & \texttt{0.459} & \texttt{+0.026} \\
tr-nodynamicprior & 3 & \texttt{1.341} & \texttt{0.969} & \texttt{-0.023} \\
tr-nodynamicprior & 7 & \texttt{1.692} & \texttt{1.239} & \texttt{-0.119} \\
tr-nomoe & 1 & \texttt{0.662} & \texttt{0.467} & \texttt{+0.002} \\
tr-nomoe & 3 & \texttt{1.346} & \texttt{0.974} & \texttt{-0.034} \\
tr-nomoe & 7 & \texttt{1.689} & \texttt{1.236} & \texttt{-0.129} \\
tr-norouter & 1 & \texttt{0.663} & \texttt{0.467} & \texttt{-0.010} \\
tr-norouter & 3 & \texttt{1.349} & \texttt{0.978} & \texttt{-0.044} \\
tr-norouter & 7 & \texttt{1.689} & \texttt{1.237} & \texttt{-0.128} \\
tr-notcn & 1 & \texttt{0.696} & \texttt{0.489} & \texttt{-0.015} \\
tr-notcn & 3 & \texttt{1.378} & \texttt{0.996} & \texttt{-0.062} \\
tr-notcn & 7 & \texttt{1.711} & \texttt{1.254} & \texttt{-0.166} \\
tr-unbounded & 1 & \texttt{0.654} & \texttt{0.462} & \texttt{+0.007} \\
tr-unbounded & 3 & \texttt{1.335} & \texttt{0.969} & \texttt{-0.057} \\
tr-unbounded & 7 & \texttt{1.679} & \texttt{1.231} & \texttt{-0.130} \\
\bottomrule\noalign{}
\end{tabularx}
}

\textbf{Table 4.8b. Skill vs persistence and climatology --- one-factor ablations.}
...
Model & h (d) & skill vs. persist & skill vs. clim \\
\midrule\noalign{}
tr-fixedkappa & 1 & \texttt{0.211} & \texttt{0.664} \\
tr-fixedkappa & 3 & \texttt{0.185} & \texttt{0.312} \\
tr-fixedkappa & 7 & \texttt{0.247} & \texttt{0.136} \\
tr-nodynamicprior & 1 & \texttt{0.211} & \texttt{0.664} \\
tr-nodynamicprior & 3 & \texttt{0.185} & \texttt{0.311} \\
tr-nodynamicprior & 7 & \texttt{0.244} & \texttt{0.132} \\
tr-nomoe & 1 & \texttt{0.202} & \texttt{0.660} \\
tr-nomoe & 3 & \texttt{0.182} & \texttt{0.309} \\
tr-nomoe & 7 & \texttt{0.245} & \texttt{0.134} \\
tr-norouter & 1 & \texttt{0.200} & \texttt{0.659} \\
tr-norouter & 3 & \texttt{0.180} & \texttt{0.307} \\
tr-norouter & 7 & \texttt{0.245} & \texttt{0.134} \\
tr-notcn & 1 & \texttt{0.161} & \texttt{0.643} \\
tr-notcn & 3 & \texttt{0.162} & \texttt{0.293} \\
tr-notcn & 7 & \texttt{0.235} & \texttt{0.123} \\
tr-unbounded & 1 & \texttt{0.211} & \texttt{0.664} \\
tr-unbounded & 3 & \texttt{0.189} & \texttt{0.315} \\
tr-unbounded & 7 & \texttt{0.249} & \texttt{0.139} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS5\_probability\_reliability.pdf\}
\textbackslash caption\{Figure S5. Event score, reliability, and expanded probabilistic diagnostics.\}
\textbackslash label\{fig:S5\}
\textbackslash end\{figure\}
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS6\_attrition\_missingness.pdf\}
\textbackslash caption\{Figure S6. Temporal opportunity, missingness, and attrition.\}
\textbackslash label\{fig:S6\}
\textbackslash end\{figure\}
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS8\_external\_arm\_failures.pdf\}
\textbackslash caption\{Figure S8. Outcome QC, external-history scope, and failure disposition.\}
\textbackslash label\{fig:S8\}
\textbackslash end\{figure\}
...
\textbackslash begin\{figure\}{[}htbp{]}
\textbackslash centering
\textbackslash includegraphics{[}width=\textbackslash textwidth{]}\{figures/figS9\_conformal\_calibration.pdf\}
\textbackslash caption\{Figure S9. Development-period conformal calibration sensitivity.\}
\textbackslash label\{fig:S9\}
\textbackslash end\{figure\}
