...
\item Primary comparisons use identical keys; HUC2 statistics remain assumption-conditional sensitivities
...
availability-enriched and spatially dependent, and that its composition follows
data availability rather than any designed sampling frame.
...
\texttt{PASS\_\allowbreak{}EXACT\_\allowbreak{}PRODUCT\_\allowbreak{}BRIDGE}. This gate can detect product-version, parsing, scaling,
...
seven-step receptive field, while the router\textquotesingle s oldest usable value is lag 14.
...
\texttt{qhat\_\allowbreak{}plus\ =\ max(raw\_\allowbreak{}qhat,\ 0)} and returns \texttt{q05\ -\ qhat\_\allowbreak{}plus}, unchanged q50, and
\texttt{q95\ +\ qhat\_\allowbreak{}plus}. Thus calibration may leave the nominal interval unchanged or
...
give every retained station equal total weight; each station\textquotesingle s row weights are
...
station/\allowbreak date/\allowbreak horizon target keys for the two models.
...
\subsection{Frozen five-comparison family and inference overlay}\label{frozen-five-comparison-family-and-inference-overlay}
...
(\href{https://www.jstor.org/stable/4615733}{Holm, 1979}). The original family-level
...
at most 15 HUC2 groups, it necessarily fails the amendment\textquotesingle s minimum-30-cluster
...
\texttt{DESCRIPTIVE\_\allowbreak{}ONLY\_\allowbreak{}INFERENCE\_\allowbreak{}GATE\_\allowbreak{}FAILED}: the fixed-cohort effect is descriptive,
...
\texttt{REV\_\allowbreak{}NOT\_\allowbreak{}EVALUATED\_\allowbreak{}NO\_\allowbreak{}PREDECLARED\_\allowbreak{}COST\_\allowbreak{}LOSS\_\allowbreak{}RATIOS}: no numerical relative economic
...
\subsection{Temporal coverage and calendar-balance audit}\label{temporal-coverage-and-calendar-balance-audit}
...
uses each forecast\textquotesingle s target date as an idealized feedback-arrival proxy; the inputs
...
primary result. If a formal test is \texttt{NOT\_\allowbreak{}ESTIMABLE}, its formal effect is \texttt{NA}, while
...
provenance, the committed \texttt{PASS\_\allowbreak{}EXACT\_\allowbreak{}PRODUCT\_\allowbreak{}BRIDGE} evidence, the predeclared
...
\item
  ...
  predictor artifacts;
\item
  freeze those outcome-free inputs, materialize the claim-blocking inference gate,
...
\item
  execute the fixed opening, physically replay and receipt-bind the temporal-
...
registry. Seasonal applicability is assigned by the seven-day window\textquotesingle s ending
...
\section{Pre-opening results placeholder and stopping rule}\label{pre-opening-results-placeholder-and-stopping-rule}

No formal result block is present in this byte-frozen pre-opening snapshot. After
a valid receipt exists, \texttt{python\ scripts/\allowbreak{}26\_\allowbreak{}validate\_\allowbreak{}claims.py\ -\/\allowbreak{}-root\ .\ -\/\allowbreak{}-registry\ protocols/\allowbreak{}route\_\allowbreak{}a\_\allowbreak{}claim\_\allowbreak{}registry\_\allowbreak{}v1.json\ -\/\allowbreak{}-write-generated-results\ -\/\allowbreak{}-require-complete} derives five deterministic blocks from the exact statistics
