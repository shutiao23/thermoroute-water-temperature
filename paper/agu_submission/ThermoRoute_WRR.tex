...
\textbf{Table 4.7a. Accuracy (RMSE, MAE, bias) --- primary models.} \emph{n} = 116 reportable stations at every lead; the Air2stream row is scored on the same common keys (118 stations with a fitted hybrid). Column groups are lead times in days. Unweighted medians over reportable stations.
...
RMSEs (1.478 and 1.825 °C) fall behind damped persistence, so the hybrid\textquotesingle s
