...
Damped persist. & \texttt{0.799} & \texttt{1.457} & \texttt{1.759} & \texttt{0.561} & \texttt{1.050} & \texttt{1.288} & \texttt{-0.034} & \texttt{-0.091} & \texttt{-0.173} \\
...
Damped persist. & \texttt{+0.036} & \texttt{+0.114} & \texttt{+0.213} & \texttt{+0.000} & \texttt{+0.000} & \texttt{+0.000} \\
...
\textbf{Table 4.8a. Accuracy (RMSE, MAE, bias) --- one-factor ablations.} Each row removes one component from ThermoRoute; the \texttt{TR-} prefix is dropped. \emph{n} = 118,275 (\emph{h} = 1 d), 117,476 (\emph{h} = 3 d), 116,524 (\emph{h} = 7 d) forecast keys. Column groups are lead times in days. Pooled over all common held-out keys, not station-medians.
...
Model & RMSE 1 & 3 & 7 & MAE 1 & 3 & 7 & bias 1 & 3 & 7 \\
\midrule\noalign{}
fixed κ & \texttt{0.654} & \texttt{1.341} & \texttt{1.684} & \texttt{0.458} & \texttt{0.970} & \texttt{1.233} & \texttt{+0.015} & \texttt{-0.043} & \texttt{-0.127} \\
no dyn. prior & \texttt{0.654} & \texttt{1.341} & \texttt{1.692} & \texttt{0.459} & \texttt{0.969} & \texttt{1.239} & \texttt{+0.026} & \texttt{-0.023} & \texttt{-0.119} \\
no MoE & \texttt{0.662} & \texttt{1.346} & \texttt{1.689} & \texttt{0.467} & \texttt{0.974} & \texttt{1.236} & \texttt{+0.002} & \texttt{-0.034} & \texttt{-0.129} \\
no router & \texttt{0.663} & \texttt{1.349} & \texttt{1.689} & \texttt{0.467} & \texttt{0.978} & \texttt{1.237} & \texttt{-0.010} & \texttt{-0.044} & \texttt{-0.128} \\
no TCN & \texttt{0.696} & \texttt{1.378} & \texttt{1.711} & \texttt{0.489} & \texttt{0.996} & \texttt{1.254} & \texttt{-0.015} & \texttt{-0.062} & \texttt{-0.166} \\
unbounded & \texttt{0.654} & \texttt{1.335} & \texttt{1.679} & \texttt{0.462} & \texttt{0.969} & \texttt{1.231} & \texttt{+0.007} & \texttt{-0.057} & \texttt{-0.130} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
Model & persist. 1 & 3 & 7 & damped 1 & 3 & 7 \\
\midrule\noalign{}
fixed κ & \texttt{+0.211} & \texttt{+0.185} & \texttt{+0.247} & \texttt{+0.181} & \texttt{+0.080} & \texttt{+0.043} \\
no dyn. prior & \texttt{+0.211} & \texttt{+0.185} & \texttt{+0.244} & \texttt{+0.181} & \texttt{+0.080} & \texttt{+0.038} \\
no MoE & \texttt{+0.202} & \texttt{+0.182} & \texttt{+0.245} & \texttt{+0.172} & \texttt{+0.076} & \texttt{+0.040} \\
no router & \texttt{+0.200} & \texttt{+0.180} & \texttt{+0.245} & \texttt{+0.170} & \texttt{+0.074} & \texttt{+0.040} \\
no TCN & \texttt{+0.161} & \texttt{+0.162} & \texttt{+0.235} & \texttt{+0.129} & \texttt{+0.055} & \texttt{+0.028} \\
unbounded & \texttt{+0.211} & \texttt{+0.189} & \texttt{+0.249} & \texttt{+0.181} & \texttt{+0.084} & \texttt{+0.046} \\
\bottomrule\noalign{}
\end{tabularx}
}
