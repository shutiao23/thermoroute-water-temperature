...
a valid receipt exists, \texttt{scripts/\allowbreak{}26\_\allowbreak{}validate\_\allowbreak{}claims.py} will derive five deterministic
blocks from the exact statistics artifact for the canonical Markdown evidence
layer. Each must appear exactly once, including negative, conflicting, or
non-estimable outcomes. Handwritten substitutions are rejected by body hashes and
evidence bindings. This TeX file remains a pre-opening methods snapshot and is not
automatically made submission-ready; a separately verified publication generator
is required after Route-A review.
