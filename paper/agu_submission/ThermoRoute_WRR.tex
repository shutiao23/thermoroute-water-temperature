...
\textbf{Each test is read at the margin it was sealed at} (Section 3.4). All five
...
\subsection{Why these numbers are smaller than published gains, and what transfers}\label{why-these-numbers-are-smaller-than-published-gains-and-what-transfers}
...
\texttt{{[}DATA\ \allowbreak{}DOI\ \allowbreak{}TO\ \allowbreak{}BE\ \allowbreak{}MINTED{]}} under \texttt{{[}DATA\ \allowbreak{}LICENCE\ \allowbreak{}TO\ \allowbreak{}BE\ \allowbreak{}ASSIGNED{]}}, pending the
