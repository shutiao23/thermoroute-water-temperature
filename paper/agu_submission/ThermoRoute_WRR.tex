...
\keypoints%
    {Station-median skill at a seven-day lead is +0.251 against persistence but +0.038 against damped persistence.}
...
convolutional network on one common set of 249,072 station/\allowbreak date/\allowbreak horizon keys,
...
raw-only gage height (\texttt{00065}, ft) for 2021--2023 are retrieved by direct
...
\textbar{} \# \textbar{} Comparison \textbar{} Lead \textbar{} ΔRMSE (°C) \textbar{} CI low \textbar{} CI high \textbar{} Win rate \textbar{} p \textbar{}
\textbar-\/-\/-\textbar-\/-\/-\textbar-\/-\/-:\textbar-\/-\/-:\textbar-\/-\/-:\textbar-\/-\/-:\textbar-\/-\/-:\textbar{}
\textbar{} 1 \textbar{} ThermoRoute vs. damped persistence \textbar{} 1 d \textbar{} \texttt{-0.129} \textbar{} \texttt{-0.199} \textbar{} \texttt{-0.090} \textbar{} \texttt{0.90} \textbar{} \texttt{\textless{}0.001} \textbar{}
\textbar{} 2 \textbar{} ThermoRoute vs. damped persistence \textbar{} 3 d \textbar{} \texttt{-0.108} \textbar{} \texttt{-0.140} \textbar{} \texttt{-0.079} \textbar{} \texttt{0.91} \textbar{} \texttt{\textless{}0.001} \textbar{}
\textbar{} 3 \textbar{} ThermoRoute vs. damped persistence \textbar{} 7 d \textbar{} \texttt{-0.069} \textbar{} \texttt{-0.088} \textbar{} \texttt{-0.057} \textbar{} \texttt{0.95} \textbar{} \texttt{\textless{}0.001} \textbar{}
\textbar{} 4 \textbar{} ThermoRoute vs. LightGBM \textbar{} 3 d \textbar{} \texttt{+0.015} \textbar{} \texttt{+0.012} \textbar{} \texttt{+0.024} \textbar{} \texttt{0.24} \textbar{} \texttt{1.000} \textbar{}
\textbar{} 5 \textbar{} ThermoRoute vs. LightGBM \textbar{} 7 d \textbar{} \texttt{-0.009} \textbar{} \texttt{-0.015} \textbar{} \texttt{-0.000} \textbar{} \texttt{0.59} \textbar{} \texttt{0.023} \textbar{}
...
positive favours the candidate); and the reportable station count \emph{n} = 116.
...
component necessity. Skill is 1 − RMSE\_model/RMSE\_baseline with both RMSEs
...
\textbf{Table 4.7a. Accuracy (RMSE, MAE, bias) --- primary models.} \emph{n} = 116 reportable stations at every lead. Column groups are lead times in days. Unweighted medians over reportable stations.
...
\midrule\noalign{}
Persistence & \texttt{0.813} & \texttt{1.638} & \texttt{2.202} & \texttt{0.597} & \texttt{1.235} & \texttt{1.686} & \texttt{-0.000} & \texttt{-0.001} & \texttt{-0.004} \\
Damped persist. & \texttt{0.789} & \texttt{1.454} & \texttt{1.773} & \texttt{0.591} & \texttt{1.100} & \texttt{1.363} & \texttt{-0.029} & \texttt{-0.076} & \texttt{-0.135} \\
Climatology & \texttt{1.899} & \texttt{1.902} & \texttt{1.903} & \texttt{1.424} & \texttt{1.427} & \texttt{1.426} & \texttt{-0.388} & \texttt{-0.386} & \texttt{-0.384} \\
LightGBM & \texttt{0.589} & \texttt{1.304} & \texttt{1.735} & \texttt{0.436} & \texttt{0.982} & \texttt{1.326} & \texttt{-0.006} & \texttt{-0.084} & \texttt{-0.178} \\
LSTM & \texttt{0.663} & \texttt{1.358} & \texttt{1.712} & \texttt{0.485} & \texttt{1.024} & \texttt{1.305} & \texttt{-0.018} & \texttt{-0.061} & \texttt{-0.137} \\
ThermoRoute & \texttt{0.640} & \texttt{1.337} & \texttt{1.694} & \texttt{0.469} & \texttt{1.001} & \texttt{1.276} & \texttt{+0.010} & \texttt{-0.028} & \texttt{-0.096} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
\midrule\noalign{}
Persistence & \texttt{+0.000} & \texttt{+0.000} & \texttt{+0.000} & \texttt{-0.030} & \texttt{-0.126} & \texttt{-0.242} \\
Damped persist. & \texttt{+0.030} & \texttt{+0.112} & \texttt{+0.195} & \texttt{+0.000} & \texttt{+0.000} & \texttt{+0.000} \\
Climatology & \texttt{-1.336} & \texttt{-0.160} & \texttt{+0.136} & \texttt{-1.406} & \texttt{-0.307} & \texttt{-0.074} \\
LightGBM & \texttt{+0.275} & \texttt{+0.204} & \texttt{+0.212} & \texttt{+0.254} & \texttt{+0.103} & \texttt{+0.022} \\
LSTM & \texttt{+0.185} & \texttt{+0.171} & \texttt{+0.222} & \texttt{+0.160} & \texttt{+0.066} & \texttt{+0.034} \\
ThermoRoute & \texttt{+0.213} & \texttt{+0.183} & \texttt{+0.230} & \texttt{+0.190} & \texttt{+0.080} & \texttt{+0.044} \\
\bottomrule\noalign{}
\end{tabularx}
}

\textbf{Table 4.8a. Accuracy (RMSE, MAE, bias) --- one-factor ablations.} Each row removes one component from ThermoRoute; the \texttt{TR-} prefix is dropped. \emph{n} = 116 reportable stations at every lead. Column groups are lead times in days. Unweighted medians over reportable stations.
...
Model & RMSE 1 & 3 & 7 & MAE 1 & 3 & 7 & bias 1 & 3 & 7 \\
\midrule\noalign{}
fixed κ & \texttt{0.635} & \texttt{1.333} & \texttt{1.695} & \texttt{0.467} & \texttt{0.996} & \texttt{1.282} & \texttt{+0.011} & \texttt{-0.029} & \texttt{-0.094} \\
no dyn. prior & \texttt{0.634} & \texttt{1.327} & \texttt{1.702} & \texttt{0.466} & \texttt{0.989} & \texttt{1.283} & \texttt{+0.024} & \texttt{-0.013} & \texttt{-0.083} \\
no MoE & \texttt{0.643} & \texttt{1.345} & \texttt{1.698} & \texttt{0.470} & \texttt{1.006} & \texttt{1.282} & \texttt{+0.000} & \texttt{-0.033} & \texttt{-0.093} \\
no router & \texttt{0.642} & \texttt{1.342} & \texttt{1.694} & \texttt{0.470} & \texttt{1.006} & \texttt{1.282} & \texttt{-0.004} & \texttt{-0.029} & \texttt{-0.093} \\
no TCN & \texttt{0.667} & \texttt{1.357} & \texttt{1.733} & \texttt{0.486} & \texttt{1.011} & \texttt{1.300} & \texttt{-0.017} & \texttt{-0.052} & \texttt{-0.125} \\
unbounded & \texttt{0.634} & \texttt{1.333} & \texttt{1.695} & \texttt{0.467} & \texttt{0.997} & \texttt{1.282} & \texttt{+0.007} & \texttt{-0.030} & \texttt{-0.095} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
Model & persist. 1 & 3 & 7 & damped 1 & 3 & 7 \\
\midrule\noalign{}
fixed κ & \texttt{+0.218} & \texttt{+0.186} & \texttt{+0.223} & \texttt{+0.195} & \texttt{+0.083} & \texttt{+0.044} \\
no dyn. prior & \texttt{+0.220} & \texttt{+0.190} & \texttt{+0.222} & \texttt{+0.196} & \texttt{+0.087} & \texttt{+0.040} \\
no MoE & \texttt{+0.208} & \texttt{+0.179} & \texttt{+0.224} & \texttt{+0.186} & \texttt{+0.075} & \texttt{+0.042} \\
no router & \texttt{+0.209} & \texttt{+0.180} & \texttt{+0.225} & \texttt{+0.186} & \texttt{+0.077} & \texttt{+0.044} \\
no TCN & \texttt{+0.178} & \texttt{+0.171} & \texttt{+0.207} & \texttt{+0.155} & \texttt{+0.067} & \texttt{+0.023} \\
unbounded & \texttt{+0.218} & \texttt{+0.186} & \texttt{+0.223} & \texttt{+0.196} & \texttt{+0.083} & \texttt{+0.044} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
\midrule\noalign{}
LightGBM & \texttt{0.907} & \texttt{0.904} & \texttt{0.903} & \texttt{1.905} & \texttt{4.142} & \texttt{5.318} & \texttt{0.020} & \texttt{0.039} & \texttt{0.049} \\
LSTM & \texttt{0.931} & \texttt{0.926} & \texttt{0.919} & \texttt{2.337} & \texttt{4.744} & \texttt{5.833} & \texttt{0.036} & \texttt{0.046} & \texttt{0.056} \\
ThermoRoute & \texttt{0.932} & \texttt{0.925} & \texttt{0.919} & \texttt{2.186} & \texttt{4.465} & \texttt{5.652} & \texttt{0.025} & \texttt{0.042} & \texttt{0.051} \\
\bottomrule\noalign{}
\end{tabularx}
}
...
\texttt{outputs/\allowbreak{}conventional/\allowbreak{}holdout\_\allowbreak{}metrics\_\allowbreak{}2021\_\allowbreak{}2023.csv}; the Table 4.7/4.8 cells
