...
Figure 3). Applying the \emph{identical} split-conformal wrapper to the two learned
...
\textbf{100 \%} of station×horizon cells (Figure 4a). The bound is not decorative --- the
...
(Figure 5). The exceedance threshold is \textbf{statistical}, set as the station-specific
