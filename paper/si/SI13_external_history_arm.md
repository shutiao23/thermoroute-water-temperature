...
disjointness alone is not evidence of hydrologic independence. Every displayed
count, score, effect, interval endpoint and status follows the README cell-level
binder contract.
