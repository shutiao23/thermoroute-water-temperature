...
| 2026-08-02 update | Stage09b config-shape repair applied and tested (new source `a4b174e1…`); run package prepared; manuscript wording batch deferred to P0-A0 closure (see `docs/M01_M14_M15_MANUSCRIPT_BATCH_DEFERRED.md`). |
