...
| T05 | P0 | v4 execution protocol and seal | IN PROGRESS: SOURCE PINS/DESIGN COMMIT PENDING | Immutable sealed copy and seal bind exact protocol bytes, registries, sources, runtime, clean design commit and authorized scope |
| T06 | P0 | Corrected 12-cell F0/F3 tree run | BLOCKED BY T05 | Twelve create-only observed-lineage shards exist with disjoint 2006--2015 train / 2016--2017 validation and exact common keys |
| T07 | P0 | Independent 12-cell authority | BLOCKED BY T06 | A second reconstruction verifies lineage, one raw cell, station metrics and paired forcing effects; point and inference authorities are frozen |
